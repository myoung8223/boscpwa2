...
!function(){if("undefined"!=typeof Prism&&"undefined"!=typeof document){var e={"(":")","[":"]","{":"}"},t={")":"(","}":"{","]":"["},n="bracket-match",r="bracket-mismatch",a=0,c=null,s=null;Prism.hooks.add("after-tokenize",function(e){var t=[];!function e(n){for(var i=0;i<n.length;i++){var o=n[i];if("string"!=typeof o)if("comment"===o.type||"string"===o.type)o.greedy&&t.push({index:a,length:o.content.length}),a+=o.content.length;else{var l=a;e(o.content),o.index=l,o.length=a-l}else a+=o.length}}(e.tokens),a=0}),Prism.hooks.add("wrap",function(a){var i=a.content;if("punctuation"===a.type&&1===i.length&&"string"==typeof i){var o=e[i]||t[i];if(o){var l=a.element,g=l.parentNode;if(g&&"code"===g.nodeName.toLowerCase()&&(g=g.parentNode),g&&"pre"===g.nodeName.toLowerCase()){var u=function(e){for(var t=e.parentNode;t&&"code"!==t.nodeName.toLowerCase();)t=t.parentNode;return t}(l);if(u){var f=u.textContent,d=function(e,t,n){for(var r=0,a=0;a<t.length;a++)if(t[a]===e&&(r++,a===n))return r;return-1}(l,u.querySelectorAll('.token.punctuation[data-bracket]'),Array.prototype.indexOf.call(u.querySelectorAll('.token.punctuation[data-bracket]'),l));l.setAttribute("data-bracket",i),l.setAttribute("data-bracket-index",d),l.addEventListener("mouseenter",function(){if(!c&&!s){var a=u.querySelectorAll('.token.punctuation[data-bracket="'+i+'"][data-bracket-index="'+d+'"]');if(2===a.length)c=a[0],s=a[1];else{var f=function(e,t,n){for(var r=0,a=-1,c=0;c<t.length;c++){var s=t[c];if(s===e){a=c;break}}if(-1!==a){var i=e.textContent,o=e.getAttribute("data-bracket"),l=n[o]?"forward":"backward",g=0;if("forward"===l){for(var u=a;u<t.length;u++)if((s=t[u]).getAttribute("data-bracket")===o?g++:s.getAttribute("data-bracket")===n[o]&&g--,0===g)return s}else for(var f=a;f>=0;f--)if((s=t[f]).getAttribute("data-bracket")===o?g++:s.getAttribute("data-bracket")===n[o]&&g--,0===g)return s}return null}(l,u.querySelectorAll(".token.punctuation"),e);f?(c=l,s=f):c=l}c&&c.classList.add(n),s&&s.classList.add(n),s===c&&c.classList.add(r)}}),l.addEventListener("mouseleave",function(){c&&(c.classList.remove(n),c.classList.remove(r)),s&&(s.classList.remove(n),s.classList.remove(r)),c=null,s=null})}}}}}})}();
